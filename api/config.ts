export default {
  ...
  MONGODB_URL                   : process.env.MONGODB_URL || "mongodb://ds155076.mlab.com:55076/datactrl",
  MONGODB_AUTH_USERNAME         : process.env.MONGODB_AUTH_USERNAME || "datactrl",
  MONGODB_AUTH_PASSWORD         : process.env.MONGODB_AUTH_PASSWORD || "datactrl1",
};
